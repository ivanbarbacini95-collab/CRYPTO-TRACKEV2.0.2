...
async function loadAccount(){
  ...
  const newRewards = (r.rewards||[]).reduce((a,v)=>a.reward.reduce((s,x)=>s+Number(x.amount),0)+a,0)/1e18;
  ...
  chart = new Chart(ctx,{
    ...
    data:{
      ...
      datasets:[{
        data: chartData,
        borderColor: "#22c55e",
        backgroundColor: ctx.createLinearGradient(0,0,0,ctx.canvas.height),
        fill: true,
        pointRadius: 0,
        tension: 0.2
      }]
...
/* Ricrea grafico ogni mezzanotte */
